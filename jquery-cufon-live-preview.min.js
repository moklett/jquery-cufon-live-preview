...
this.toolbarUpdateButton.show()};b.prototype.update=function(){this.previewPane.show();this.textarea.hide();!0!=this.settings.hideEditButton&&this.toolbarEditButton.show();this.toolbarUpdateButton.hide();this.previewPane.html(this.content());this.preview()};b.prototype.previewPaneSelector=function(){return"#"+this.root.attr("id")+" .clpwidget_preview"};return{Widget:b,fontRegistry:[],registerFont:function(a){CufonLivePreview.fontRegistry.push(a.face["font-family"]);Cufon.registerFont(a);return a}}}(jQuery);
